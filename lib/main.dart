...
class _AppBarExampleState extends State<AppBarExample> {
  ...
  Widget build(BuildContext context) {
    ...
    Future <TimeSeriesData> getTimeSeries() async{
      final response = await http.get(Uri.parse('${url}/api/timeseries?battery=${widget.BatteryID}&cell=${widget.CellID}&start=${widget.StartDate}T00:00:00Z&end=${widget.EndDate}T23:59:59Z&interval=$interval'));
